...
def get_lanbide_data():
    ...
    ara_mun_list = ['001', '002', '003', '004', '006', '008', '009', '010', '011', '013', '014', '016', '017', '018',
                    '019', '020', '021', '022', '023', '027', '028', '030', '031', '032', '033', '034', '036', '037',
                    '039', '041', '042', '043', '044', '046', '047', '049', '051', '052', '053', '054', '055', '056',
                    '057', '058', '060', '061', '062', '063', '901', '902']

    gip_mun_list = ['001', '002', '003', '004', '005', '006', '007', '008', '009', '010', '011', '012', '013', '014',
    ...
    biz_mun_list = ['001', '002', '003', '004', '005', '006', '007', '008', '009', '010', '011', '012', '013', '014',
                    '015', '016', '017', '018', '019', '020', '021', '022', '023', '024', '025', '026', '027', '028',
                    '029', '030', '091', '092', '093', '094', '095', '096', '097', '901', '902', '903', '904', '905',
